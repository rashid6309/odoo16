...
class MedicalPhysicalExamination(models.Model):
    ...
    female_thyroid_goitear_length = fields.Char('Goitear')
    female_thyroid_goitear_width = fields.Char('Goitear')
    female_thyroid_goitear_type = fields.Selection(selection=StaticMember.THYROID_GOITEAR_TYPE, string='Goitear')
