...
class MedicalPhysicalExamination(models.Model):
    ...
    female_thyroid_goitear_length = fields.Selection(selection=StaticMember.GOITEAR_LENGTH, string='Goitear Length')
    female_thyroid_goitear_width = fields.Selection(selection=StaticMember.GOITEAR_LENGTH, string='Goitear Width')
