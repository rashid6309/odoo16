...
class FirstConsultation(models.Model):
    ...
    _inherits = {'ec.general.history': 'ec_general_examination_id',
                 ...
                 'ec.female.family.history': 'female_family_history_id',
                 ...
                 'ec.male.family.history': 'male_family_history_id',
                 }
    ...
    ''' Female '''
    ec_obstetrics_history_id = fields.Many2one(comodel_name="ec.obstetrics.history", ondelete='restrict')
    ec_gynaecological_history_id = fields.Many2one(comodel_name="ec.gynaecological.history", ondelete='restrict')
    ec_social_history_id = fields.Many2one(comodel_name="ec.social.history", ondelete='restrict')
    ec_medical_history_id = fields.Many2one(comodel_name="ec.medical.history", ondelete='restrict')
    ...
    female_family_history_id = fields.Many2one(comodel_name="ec.female.family.history", ondelete='restrict')

    ''' Female One2many '''
    pat_procedures = fields.One2many(comodel_name='ec.medical.patient.procedures',
    ...
    male_family_history_id = fields.Many2one(comodel_name="ec.male.family.history", ondelete='restrict')
    ''' Male One2Many'''
