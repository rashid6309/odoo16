...
class ReportCompanyTemplate(models.Model):
    ...
    document_layout_id = fields.Many2one(
        "doc.layout", string="Invoice Layout Configuration"
    )
...
class TemplateInvoice(models.Model):
    ...
    theme_id = fields.Many2one("doc.layout", related="company_id.document_layout_id")


class BaseDocumentLayout(models.TransientModel):
    _inherit = "base.document.layout"

    base_layout = fields.Selection(related="company_id.base_layout", readonly=False)
    document_layout_id = fields.Many2one(
